...
export default function AdminLeadsPage() {
  ...
  // Fetch leads and agents on mount
  useEffect(() => {
    fetchLeads();
    fetchAgents();
  }, []);
      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
        ...
        {(filterStatus || filterPriority) && (
          <button
            ...
            style={{ padding: '8px 12px', borderRadius: '8px', border: '1px solid #d1d5db', background: 'white', cursor: 'pointer', fontSize: '14px' }}
          >
            Clear Filters
          </button>
        )}
            ...
            <form onSubmit={handleCreate}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Plot, Apartment, House..."
                />
              </div>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <button
                  ...
                  style={{ flex: 1, padding: '10px', border: '1px solid #d1d5db', borderRadius: '8px', background: 'white', cursor: 'pointer' }}
                >
                  Cancel
                </button>
              </div>
